<template>
  <div class="inline-grid grid-cols-2 gap-4 mt-4 mx-auto">   
    ...
    <a
      ...
      <div
        class="g-ytsubscribe"
        data-channelid="UCOmgOC5nvjRiobtlFnoyZKQ"
        data-layout="default"
        data-theme="dark"
        data-count="default"
      ></div>
    ...
    >
    <a
      class="btn btn-ribbon px-1 items-center justify-center inline-block align-middle flex flex-col relative"
      href="https://github.com/jandae"
      target="_blank"
    >
      Github
      <div class="ribbon text-sm whitespace-no-wrap px-4">Jank Warning</div>
    </a>
    <a
    ...
    <a
      ...
      <div
        class="g-ytsubscribe"
        data-channelid="UCS4bNn83QPhGftBoGmKf7ew"
        data-layout="default"
        data-theme="dark"
        data-count="default"
      ></div>
